    ...
    extends MercadoPago_Core_Model_Api_Exception
{
    protected $messagesMap =
        array(
            ...
            3021 => 'Cardholder documentnumber can not be empty. Please check the form data and retry.',
            ...
            4004 => 'Installments atributte can not be empty, Please check the form data and retry.',
            4026 => 'Coupon_amount is invalid, Please check the form data and retry.',
